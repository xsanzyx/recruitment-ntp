...
<head>
    ...
    <title>@yield('title', 'Dashboard Manager') — NTP Careers</title>
    ...
    <style>
        ...
        #mgrMain { padding-top: 60px; }
        @media(min-width: 1024px) {
            #mgrMain { padding-top: 20px; }
...
<div id="sidebar" class="sidebar flex flex-col z-[1000]">
    ...
    <ul class="sidebar-menu list-none p-0" style="flex:0;">
        <li class="mb-[1px]">
            <a href="{{ route('manager.dashboard') }}" class="{{ request()->routeIs('manager.dashboard') ? 'active' : '' }}">
                <i class="bi bi-grid-1x2"></i> Dashboard Manager
            </a>
        </li>
        <li class="mb-[1px]">
            <a href="{{ route('manager.applications.index') }}" class="{{ request()->routeIs('manager.applications.*') ? 'active' : '' }}">
                <i class="bi bi-people"></i> Pelamar Departemen
            </a>
        </li>
    </ul>
    ...
    <div class="sidebar-bottom mt-auto">
        <div class="cta-box mb-3 text-center">
            ...
            <div style="font-size:11px; color:#94a3b8; margin-top:2px;">Manager — {{ Auth::user()->department }}</div>
        </div>
...
{{-- ═══════════════ MAIN CONTENT ═══════════════ --}}
<main id="mgrMain" class="min-h-screen flex flex-col transition-all lg:ml-16">
