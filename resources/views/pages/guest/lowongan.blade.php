...
<section class="jobs-section" style="padding-top: 100px;">
    <div class="container">
        ...
        <div class="fade-up mb-5">
            ...
            <p class="hero-subtitle">Cari berdasarkan posisi atau skill, lalu saring berdasarkan departemen dan divisi.</p>
        </div>
        ...
        <div class="fade-up mb-4">
            <div class="d-flex flex-wrap gap-3 align-items-center">
                <div class="search-bar flex-grow-1" style="max-width: 460px;">
                    ...
                    <input type="text" id="search-input" placeholder="Cari posisi, skil, departemen, atau divisi">
                </div>
                <select class="form-select" id="filter-dept" style="max-width: 200px; border-radius: 10px; border: 1px solid #e5e7eb; padding: 10px 14px; font-size: 14px;">
                    <option value="">Semua Departemen</option>
                    <option value="Information Technology">Information Technology</option>
                    <option value="Design & User Experience">Design & User Experience</option>
                    <option value="Business Development">Business Development</option>
                </select>
                <select class="form-select" id="filter-divisi" style="max-width: 180px; border-radius: 10px; border: 1px solid #e5e7eb; padding: 10px 14px; font-size: 14px;">
        ...
        <div class="d-flex flex-column gap-3" id="job-list">
            ...
            <div class="job-card fade-up" data-dept="Information Technology" data-tipe="Full-Time">
                <div class="job-header">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            ...
                            <small style="color:#64748b;">Information Technology</small>
                        </div>
                    </div>
            ...
            <div class="job-card fade-up" data-dept="Design & User Experience" data-tipe="Full-Time">
                <div class="job-header">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            ...
                            <small style="color:#64748b;">Design & User Experience</small>
                        </div>
                    </div>
                    <small class="toggle-text" style="color:var(--primary-color);cursor:pointer;">Lihat detail <i class="bi bi-chevron-down"></i></small>
                </div>
            ...
            <div class="job-card fade-up" data-dept="Business Development" data-tipe="Full-Time">
                <div class="job-header">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            ...
                            <small style="color:#64748b;">Business Development</small>
                        </div>
                    </div>
                    <small class="toggle-text" style="color:var(--primary-color);cursor:pointer;">Lihat detail <i class="bi bi-chevron-down"></i></small>
                </div>
...
<script>
    ...
    function filterJobs() {
        ...
        const tipe = filterDivisi.value.toLowerCase();
        let visible = 0;
